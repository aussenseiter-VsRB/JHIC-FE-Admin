...
3. Read the relevant section docs (e.g., `docs/modules/RULES.md` for module work).
4. Read `type: Enforce` docs before writing any code.
5. For module creation, read the examples in `docs/modules/examples/{moduleName}/` for reference.
